...
CRASHRPTAPI(int) crInstallW(CR_INSTALL_INFOW* pInfo)
{
	...
	LPCTSTR pszCompressionPassword = strconv.w2t((LPWSTR)pInfo->pszCompressionPassword);
...
CRASHRPTAPI(int) crInstallA(CR_INSTALL_INFOA* pInfo)
{
	...
	LPCTSTR pszCompressionPassword = strconv.a2t((LPSTR)pInfo->pszCompressionPassword);
